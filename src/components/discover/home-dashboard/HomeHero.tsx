...
export function HomeHero({ writeHref, workspaceHref }: { writeHref: string; workspaceHref: string }) {
  return (
    <div className="relative h-[335px] overflow-hidden rounded-2xl bg-slate-900 shadow-sm">
      <Image
      ...
      />
      <div className="relative z-[1] max-w-[590px] px-10 pt-12">
        ...
        <h1 className="font-content text-[38px] leading-[1.08] font-bold tracking-[-1.8px]">
        ...
        <div className="mt-6 flex gap-3">
          <Link
            href={writeHref}
            className="flex items-center gap-2 rounded-lg bg-[#162033] px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-black"
          >
          ...
          <Link
            href={workspaceHref}
            className="flex items-center gap-2 rounded-lg bg-white/90 px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-slate-200"
          >
