...
// KHONG phai anh that cua tung linh vuc. The CO CHU DICH thap hon
// AttentionCollectionsRail.tsx (86px vs 166px) - day la list phu/luot qua
// nhanh (chi ten linh vuc + so bai), khac voi "Bộ sưu tập đang được chú ý"
// can dat nang anh bia hon.
