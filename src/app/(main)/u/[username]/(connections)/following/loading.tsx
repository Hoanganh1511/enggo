...
// KHONG boc them ProfileContentWrap o day - {children} da nam san trong 1
// lop ProfileContentWrap (+ py-4) cua ProfileShell.tsx roi, boc them se bi
// cong don padding ngang (px-35 x 2), lech han so voi luc co du lieu that.
