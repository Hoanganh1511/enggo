...
export default async function ContestListPage() {
  ...
  return (
    // Khong tu them px/py: shell cha (HomeLayoutShell qua contest/layout.tsx)
      ...
      {STATUS_SECTIONS.map(({ status, title }) => {
        ...
        return (
          <section key={status}>
            ...
            {/* 3 cot o man hinh rong, tu rut cot khi hep - dung auto-fill de
                the luon lap day chieu ngang thay vi chua khoang trong cuoi
                hang (cung ky thuat nhu luoi bai viet o SingleTypeFeedList). */}
